(() => {
    ...
    (() => {
        ...
        var sliderFirst = document.getElementById("slider-first");
        var sliderSecond = document.getElementById("slider-second");
        document.getElementById("slider-third");
        ...
        var inputFirst = document.getElementById("input-first");
        var inputSecond = document.getElementById("input-second");
        document.getElementById("input-third");
        var firstNumber = 0;
        var secondNumber = 0;
        sliderFirst.noUiSlider.on("update", (function(values, handle) {
            inputFirst.value = values[handle];
            firstNumber = values[handle];
        }));
        sliderSecond.noUiSlider.on("update", (function(values, handle) {
            inputSecond.value = values[handle];
            secondNumber = values[handle];
        }));
        inputFirst.addEventListener("change", (function() {
            sliderFirst.noUiSlider.set(this.value);
        }));
        inputSecond.addEventListener("change", (function() {
            sliderSecond.noUiSlider.set(this.value);
        }));
        function MyRound10(val) {
            return 100 * Math.round(val / 100);
        }
        const finish = document.querySelector(".credit__finish");
        setInterval((() => {
            finish.innerHTML = MyRound10((389e4 - parseInt(firstNumber.replace(/ /g, ""))) / parseInt(secondNumber.replace(/ /g, ""))) + " р/мес";
        }));
        ...
        function initSliders() {
            if (document.querySelector(".review")) new core(".review__slider", {
            ...
            if (document.querySelector(".availability")) new core(".availability__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                pagination: {
                    el: ".availability__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".availability__button-prev",
                    nextEl: ".availability__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.4,
        ...
        const icons = document.querySelectorAll("#test-drive-icon");
        icons.forEach((icon => {
